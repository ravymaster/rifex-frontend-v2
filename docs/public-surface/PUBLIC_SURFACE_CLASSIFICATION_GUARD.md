...
> **2026-09-04 — PROMOVIDO A PROD.** Autorizado explícitamente por Rodrigo ("GO A PROD"). `origin/main` avanzó desde `7fcc1c5` (tag `v2.7-rifex-prod-progressive-onboarding`) promoviendo este trabajo DEV certificado junto con Difusión V1.1. Ver `docs/WOP.md`, "RIFEX PSCG + DIFUSIÓN V1.1 MULTIPRODUCTO — PROD PROMOTION (2026-09-04)" para el detalle completo. PSCG es ahora la regla vigente en PROD, no solo en DEV — toda ruta nueva de Rifex, en cualquier rama, debe clasificarse acá antes de mergear.
