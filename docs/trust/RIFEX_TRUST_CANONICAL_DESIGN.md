...
Documento maestro del sistema Rifex Trust. Diseño puro — **nada de esto está implementado**. Referencia el resto de `docs/trust/` para el detalle de cada área; este documento consolida el objetivo, los documentos por producto, el motor de riesgo y la arquitectura propuesta.
