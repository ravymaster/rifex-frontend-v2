...
> **2026-09-04 — PROMOVIDO A PROD (V1.1 multiproducto).** Autorizado explícitamente por Rodrigo ("GO A PROD"). `origin/main` avanzó desde `7fcc1c5` promoviendo la versión multiproducto certificada (ver sección "V1.1 — Multiproducto" más abajo). Ver `docs/WOP.md`, "RIFEX PSCG + DIFUSIÓN V1.1 MULTIPRODUCTO — PROD PROMOTION (2026-09-04)" para el detalle completo de la promoción.
