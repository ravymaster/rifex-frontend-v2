...
// RIFEX PRODUCT LANDINGS V1 — landing comercial de Eventos. PSCG:
// PUBLIC_INDEXABLE. /eventos sigue siendo el catálogo real de eventos
// publicados (src/pages/eventos/index.jsx) y no se toca — esta página
// vive en /soluciones/eventos precisamente para no competir con esa
// función. Todo lo descrito abajo es una función real y verificada del
// producto (crear-evento.jsx, eventos/[id].jsx, panel/eventos/[id].jsx,
// panel/eventos/[id]/scanner.jsx, eventStaffAuth.js,
// eventAnalyticsWorkbook.js, platformFee.js) — ninguna capacidad
// inventada.
...
export default function EventosLanding() {
  const url = canonicalUrl('/soluciones/eventos');
  ...
  return (
    <Layout
      ...
      canonicalPath="/soluciones/eventos"
    >
      <Head>
