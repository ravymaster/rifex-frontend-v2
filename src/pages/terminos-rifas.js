// pages/terminos-rifas.js
// STAGE 2 REPAIR — separación de superficie pública: estas son las
// condiciones históricas/específicas del producto Rifas, movidas
// verbatim desde terminos.js (nunca reescritas, nunca reinterpretadas)
// para que la superficie corporativa pública (/terminos) deje de
  ...
  return (
    <>
      <main style={{maxWidth:900, margin:"0 auto", padding:"24px 16px"}}>
        <h1 style={{marginBottom:8}}>Términos y Condiciones — Rifas</h1>
        <p style={{color:"#6B7280"}}>
          Condiciones específicas del producto Rifas. Complementan los <a href="/terminos">Términos y Condiciones
          generales de Rifex</a>, que siguen aplicando en lo que corresponda.
        </p>
        ...
        <section id="rifex">
          <h2>Condiciones de Uso de Rifex — Rifas</h2>
          <ol>
...
TerminosRifas.getLayout = (page) => (
  <Layout
    title="Términos y Condiciones — Rifas — Rifex"
    description="Condiciones específicas del producto Rifas de Rifex, complementarias a los Términos y Condiciones generales."
    noindex
  >
    {page}
  </Layout>
