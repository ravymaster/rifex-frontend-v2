...
test('14. DEV banner es infraestructura de _app.js, nunca del asset ni de este archivo — PROD no lleva DevBanner por diseño (tooling exclusivo DEV, ver authUxCrawler.test.mjs), esta versión certifica su ausencia', () => {
  const appSrc = read('src/pages/_app.js');
  assert.doesNotMatch(appSrc, /DevBanner/);
